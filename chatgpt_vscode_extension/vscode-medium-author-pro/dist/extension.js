...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getGptCompletion = exports.GptGetter = void 0;
const axios_1 = __importDefault(__webpack_require__(3));
const ApiKey = __importStar(__webpack_require__(44));
...
class GptGetter {
    ...
    getGptCompletion = async (prompt) => {
        ...
        try {
            ...
            const response = await axios_1.default.post(OPENAPI_API_URL, data, {
                headers: HEADERS,
            });
            const gptRsp = response.data;
